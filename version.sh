...
export SSR_VER=$(wget --no-check-certificate -qO- https://raw.githubusercontent.com/shadowsocksrr/shadowsocksr/akkariiin/master/shadowsocks/version.py | grep return | cut -d\' -f4 | awk '{print $1}')
